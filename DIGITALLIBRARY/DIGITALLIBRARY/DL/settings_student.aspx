...
CodeBehind="settings_student.aspx.cs" Inherits="DIGITALLIBRARY.DL.settings_student" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="style2">
            <td class="style15" colspan="6" height="70" align="center" 
                bgcolor="#99CCFF">
            <asp:Label ID="lblSettingStudent" runat="server" Text="SETTING STUDENT"></asp:Label>
        </td>
    <tr>
        <td class="style3">
                Name:</td>
