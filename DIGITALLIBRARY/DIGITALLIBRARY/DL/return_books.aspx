...
CodeBehind="return_books.aspx.cs" Inherits="DIGITALLIBRARY.DL.return_books" EnableEventValidation="false" %>
    ...
    <table class="style2">
        <tr>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:ImageButton ID="imgbtnRefresh" runat="server" Height="35px" 
                    ImageUrl="~/Images/refresh-512.png" onclick="imgbtnRefresh_Click" 
                    Width="47px" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="style4">
                CRN:</td>
            <td class="style3">
                <asp:TextBox ID="txtCrn" runat="server" Width="200px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style4">
        ...
        <tr>
            <td class="style4">
                <asp:Label ID="lblMsg" runat="server">Penalty</asp:Label>
            </td>
            <td class="style3">
                <asp:TextBox ID="txtPenatlty" runat="server" Width="200px"></asp:TextBox>
                <asp:CheckBox ID="chkboxPaid" runat="server" 
                    oncheckedchanged="chkboxPaid_CheckedChanged" Text="Paid" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="IM_ID" HeaderText="Master ID" />
                        <asp:BoundField DataField="ID_ID" HeaderText="Detail ID" />
