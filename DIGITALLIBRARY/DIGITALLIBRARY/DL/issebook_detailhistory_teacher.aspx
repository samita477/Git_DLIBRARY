<%@ Page Title="" Language="C#" MasterPageFile="~/DL/DLL.Master" AutoEventWireup="true" CodeBehind="issebook_detailhistory_teacher.aspx.cs" Inherits="DIGITALLIBRARY.DL.issebook_detailhistory_teacher" EnableEventValidation="false"%>
            ...
            <td>
                ...
                bgcolor="#99CCFF">
                    ...
                    CellPadding="4" GridLines="Horizontal" Width="940px">
                                <Columns>
                                    <asp:BoundField DataField="IDT_ID" HeaderText="Id" />
