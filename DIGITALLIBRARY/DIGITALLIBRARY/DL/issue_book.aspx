<%@ Page Title="" Language="C#" MasterPageFile="~/DL/DLL.Master" AutoEventWireup="true"
    CodeBehind="issue_book.aspx.cs" Inherits="DIGITALLIBRARY.DL.issue_book" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="style2">
        <tr>
            <td class="style1" colspan="5" width="200" height="70" align="center" bgcolor="#99CCFF">
        ...
        <tr>
            <td class="style4">
                BarCode:</td>
            <td class="style5">
                <asp:TextBox ID="txtSCode" runat="server" Width="200px" 
        ...
        <tr>
            ...
            <td class="style5">
                <asp:DropDownList ID="ddlStudent" runat="server" AutoPostBack="true" Width="200px"
                    OnSelectedIndexChanged="ddlStudent_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
            <td class="style5">
                <asp:LinkButton ID="lbtnIssueDetails" runat="server" OnClick="lbtnIssueDetails_Click">View Issue Details</asp:LinkButton>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td class="style5">
                <asp:TextBox ID="txtGender" runat="server" Width="200px" Height="30px"></asp:TextBox>
            </td>
            <td class="style5">
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td class="style6">
                <asp:TextBox ID="txtCrn" runat="server" Width="200px" Height="30px"></asp:TextBox>
            </td>
            <td class="style6">
                &nbsp;
            </td>
        ...
        <tr>
            <td colspan="5">
                <asp:GridView ID="gvIssueBook" runat="server" AutoGenerateColumns="False" BackColor="White"
                    BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4"
                    GridLines="Horizontal" ShowFooter="True" Width="1019px">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Book Name">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlBook" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddlBook_SelectedIndexChanged">
                                </asp:DropDownList>
                            </ItemTemplate>
                        </asp:TemplateField>
        ...
        <tr>
            ...
            <td class="style6">
                <asp:Button ID="btnIssue" runat="server" OnClick="btnIssue_Click" Text="Issue Book"
                    Width="135px" />
